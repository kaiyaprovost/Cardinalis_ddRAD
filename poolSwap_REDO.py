...
def allDictPermutations(clusterDict,indexList,outfile):
	...
	for permTUP in permuteList:
				...
				if barcodeSwap == barcodeOrig:
					...
					for i in range(len(swapKeyTO)):
						...
						if toKey[:2] == fromKey[:2]:
							...
							swapDict[toKey] = [fromClust,toPool,fromBarcode,toDes]
		...
		for i in ["P1_P1F_01","P1_P1F_2","P1_P1F_3","P1_P1F_4","P1_P1F_5","P1_P1F_6","P1_P1F_15","P1_P1F_16"]:
			...
			actualOrder.append([tempValues[2],i])
		actualOrder.sort()
		#print "ACTUAL ORDER"
		for j in actualOrder:
			print >>outfile, int(j[1][-3:].replace("_","").replace("F","")),
		print >>outfile,"\n",
		#print
